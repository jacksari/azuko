        ...
        <footer className=" flex flex-col absolute  w-full bg-primary-400">
            <div className="py-10 md:py-16 w-full mx-auto max-w-7xl sm:px-6 lg:px-8 flex flex-col md:flex-row md:items-start md:justify-between">
                <div className="flex flex-col w-full md:w-1/1 lg:w-1/4 pr-12 px-10 md:px-4 mb-6 md:mb-0">
                    <h3 className="text-secondary-500 text-lg font-bold mb-3">Contáctanos</h3>
                    <p className="flex items-center mb-3">
                        <FiMapPin color="#D36690" size="1.2rem"/>
                        <span className="ml-4 text-secondary-500 text-sm font-light">Av. Principal 123, Lima</span>
                    </p>
                    <p className="flex items-center mb-3">
                        <FiPhone color="#D36690" size="1.2rem"/>
                        <span className="ml-4 text-secondary-500 text-sm font-light">+51 999 999 999</span>
                    </p>
                    <p className="flex items-center mb-3">
                    ...
                    <div className="flex items-center mt-4">
                        <a href="https://www.facebook.com/Micole.peru" className="mr-6 hover:bg-white hover:bg-opacity-25 p-2 rounded transition">
                            <FaFacebookF color="#D36690" size="1.2rem"/>
                        </a>
                        <a href="#" className="mr-6 hover:bg-white hover:bg-opacity-25 p-2 rounded transition">
                            <FaTwitter color="#D36690" size="1.2rem"/>
                        </a>
                        <a href="#" className="mr-6 hover:bg-white hover:bg-opacity-25 p-2 rounded transition">
                            <FaInstagram color="#D36690" size="1.2rem"/>
                        </a>
                        <a href="#" className="mr-6 hover:bg-white hover:bg-opacity-25 p-2 rounded transition">
                            <FaLinkedinIn color="#D36690" size="1.2rem"/>
                        </a>
                    </div>
                </div>
                <div className="flex flex-col w-full md:w-1/1 lg:w-1/4 px-10 md:px-4 mb-6 md:mb-0">
                    <h3 className="text-secondary-500 text-lg font-medium mb-3">Menú</h3>
                    <Link href="/">
                        <a className="text-secondary-500 text-sm font-light my-2">
                            Inicio
                        </a>
                    </Link>
                    <Link href="/">
            ...
            <div className="border-t-1 border-footer ">
                <div className="py-8 w-full mx-auto max-w-7xl sm:px-6 lg:px-8 flex flex-col md:flex-row md:items-start md:justify-between">
                    ...
                    <div className="text-center">
                        ...
                        <Link href="/blogs">
                            <a className="text-secondary-500 text-xs md:text-sm font-light my-2 md: mx-2">blog</a>
                        </Link>
                        <Link href="/terminos-condiciones">
                            <a className="text-secondary-500 text-xs md:text-sm font-light my-2 md:mx-2">Términos y condiciones</a>
                        </Link>
                    </div>
                </div>
            </div>
